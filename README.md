...
# Autor: Luiz Fernando
# Objetivo: Analisar dados estatísticos de e-commerce
# utilizando diferentes tipos de visualizações.
# =====================================================
...
def main():
    ...
    if len(colunas_numericas) < 1:
        raise ValueError("O dataset precisa ter pelo menos uma coluna numérica.")
